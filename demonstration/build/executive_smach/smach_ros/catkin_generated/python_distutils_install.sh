...
echo_and_run cd "/home/nickolay/demonstration/src/executive_smach/smach_ros"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/nickolay/demonstration/build/executive_smach/smach_ros \
    build --build-base "/home/nickolay/demonstration/build/executive_smach/smach_ros" \
    install \
    --root="${DESTDIR-/}" \
