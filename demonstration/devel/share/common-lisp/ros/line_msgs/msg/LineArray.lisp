...
(cl:defclass <LineArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (lines
    :reader lines
    :initarg :lines
    :type (cl:vector line_msgs-msg:Line)
   :initform (cl:make-array 0 :element-type 'line_msgs-msg:Line :initial-element (cl:make-instance 'line_msgs-msg:Line))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LineArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LineArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name line_msgs-msg:<LineArray> is deprecated: use line_msgs-msg:LineArray instead.")))
...
(cl:defmethod lines-val ((m <LineArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader line_msgs-msg:lines-val is deprecated.  Use line_msgs-msg:lines instead.")
  (lines m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LineArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lines)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'line_msgs-msg:Line))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LineArray>)))
  ...
  "67b24130203bbd6fa25f7fed2d1b50b9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LineArray)))
  "Returns md5sum for a message object of type 'LineArray"
  "67b24130203bbd6fa25f7fed2d1b50b9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LineArray>)))
  ...
  (cl:format cl:nil "Header header~%line_msgs/Line[] lines~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: line_msgs/Line~%Header header~%geometry_msgs/Point first~%geometry_msgs/Point second~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LineArray)))
  "Returns full string definition for message of type 'LineArray"
  (cl:format cl:nil "Header header~%line_msgs/Line[] lines~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: line_msgs/Line~%Header header~%geometry_msgs/Point first~%geometry_msgs/Point second~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
