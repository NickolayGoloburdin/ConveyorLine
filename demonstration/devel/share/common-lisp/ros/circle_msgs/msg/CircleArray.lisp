...
(cl:defclass <CircleArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (circles
    :reader circles
    :initarg :circles
    :type (cl:vector circle_msgs-msg:Circle)
   :initform (cl:make-array 0 :element-type 'circle_msgs-msg:Circle :initial-element (cl:make-instance 'circle_msgs-msg:Circle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CircleArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CircleArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name circle_msgs-msg:<CircleArray> is deprecated: use circle_msgs-msg:CircleArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CircleArray>))
...
(cl:defmethod circles-val ((m <CircleArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader circle_msgs-msg:circles-val is deprecated.  Use circle_msgs-msg:circles instead.")
  (circles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CircleArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'circles)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'circle_msgs-msg:Circle))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CircleArray>)))
  ...
  (cl:format cl:nil "Header header~%circle_msgs/Circle[] circles~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: circle_msgs/Circle~%Header header~%geometry_msgs/Point center~%float64 radius~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CircleArray)))
  "Returns full string definition for message of type 'CircleArray"
  (cl:format cl:nil "Header header~%circle_msgs/Circle[] circles~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: circle_msgs/Circle~%Header header~%geometry_msgs/Point center~%float64 radius~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
